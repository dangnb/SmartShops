...
namespace Shop.Apptication.UserCases.V1.Metadata.Queries.Customers;
public class GetCategoryByIdQueryHandler : IQueryHandler<Query.GetCustomerByIdQuery, Response.CustomerResponse>
{
