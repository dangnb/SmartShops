...
import { PermissionSaveComponent } from './permission-save/permission-save.component';
import { NgxPaginationModule } from 'ngx-pagination';



@NgModule({
  declarations: [PermissionListingComponent, PermissionDetailsComponent, PermissionSaveComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
