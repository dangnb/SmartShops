...
import { VillageListingComponent } from './village-listing/village-listing.component';
import { VillageSaveComponent } from './village-save/village-save.component';


@NgModule({
  declarations: [VillageListingComponent,VillageSaveComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    RouterModule.forChild([
      {
        path: '',
        component: VillageListingComponent,
      }
