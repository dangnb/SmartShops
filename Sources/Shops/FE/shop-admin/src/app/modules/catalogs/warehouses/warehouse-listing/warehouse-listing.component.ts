...
import { WarehouseService } from 'src/app/_services/warehouce.service';
@Component({
  selector: 'app-warehouse-listing',
  templateUrl: './warehouse-listing.component.html',
  styleUrls: ['./warehouse-listing.component.scss'],
})
export class WarehouseListingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  edit(id: string) {
    const modalRef = this.modalService.open(WarehouseSaveComponent, {
      size: 'lg',
      backdrop: 'static',
      keyboard: true,
    });
